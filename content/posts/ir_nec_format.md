...
[この記事](/posts/summer_vacation_android_ir/)の赤外線パターンを見て見る編です


## 赤外線のパターンではない謎の16進数について
...
赤外線LEDを`8925ミリ秒`ONにして、`4540ミリ秒`OFFにして、`514ミリ秒`ONにする...って意味です。
...
fun main(){
    val pattern = listOf(8992, 5058, 562, 562, 562, 1686, 562, 562, 562)
    // グループ化
